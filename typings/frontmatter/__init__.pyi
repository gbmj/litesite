...
from .util import u
from .default_handlers import BaseHandler, JSONHandler, TOMLHandler, YAMLHandler
...
def parse(text: str, encoding: str = ..., handler: BaseHandler | None = ..., **defaults: object) -> tuple[dict[str, object], str]:
    """
...
def check(fd: str | io.IOBase, encoding: str = ...) -> bool:
    """
...
def checks(text: str, encoding: str = ...) -> bool:
    """
...
def load(fd: str | io.IOBase, encoding: str = ..., handler: BaseHandler | None = ..., **defaults: object) -> Post:
    """
...
def loads(text: str, encoding: str = ..., handler: BaseHandler | None = ..., **defaults: object) -> Post:
    """
...
def dump(post: Post, fd: str | io.IOBase, encoding: str = ..., handler: BaseHandler | None = ..., **kwargs: object) -> None:
    """
...
def dumps(post: Post, handler: BaseHandler | None = ..., **kwargs: object) -> str:
    """
...
class Post:
    ...
    """
    def __init__(self, content: str, handler: BaseHandler | None = ..., **metadata: object) -> None:
        ...
